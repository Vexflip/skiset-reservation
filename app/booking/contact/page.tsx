...
export default function ContactPage() {
    ...
    return (
        <div className="animate-fade-in max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-8">Please provide your details to confirm the reservation.</p>

            {/* Order Summary */}
            <div className="bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
            ...
            <form onSubmit={handleSubmit} className="bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
